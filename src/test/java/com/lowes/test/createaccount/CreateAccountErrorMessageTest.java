...
public class CreateAccountErrorMessageTest extends BaseTest{
	...
	public void missingEmailId() {
		...
		Assert.assertEquals(signUpPage.getRequiredFieldErrorMessage(), "The password entry fields do not match. Please enter the same password in both fields and try again.");
	}
